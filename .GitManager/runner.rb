...
subfolders.each do |folder|
  ...
  folder.children.each do |child|
    ...
    content = File.read(child.join("pattern.js"))
      File.open(child.join("README.md"), "w+") do |f|
        f.puts  "#### ! For the code to work correctly use: 'live server' or npx http-server !"
        f.puts "[![Pattern Checked Buttons](https://github.com/AndriiKot/VanillaJS__Cooks/blob/main/#{link}/__preview__/__v1_0_0__.png)](https://github.com/AndriiKot/VanillaJS__Cooks/blob/main/#{link}/_00-0__Best__Praxe__)"
        f.puts "```js"
        f.puts content
        f.puts "```"
      end
  ...
  if folder.basename.to_s.match?(/^_(\d{1})/)
    ...
    File.open(folder.join("README.md"), "w+") do |f|
      f.puts("# #{pattern_name}")
      f.puts "[![#{pattern_name}](https://github.com/AndriiKot/VanillaJS__Cooks/blob/main/#{link}/__preview__/__v1_0_0__.png)](https://github.com/AndriiKot/VanillaJS__Cooks/blob/main/#{link}/_00-0__Best__Praxe__)"
      f.puts("### Best Praxe: ")
      f.puts("```js")
